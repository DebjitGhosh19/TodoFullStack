...
const Signin = () => {
  ...
  return (
    ...
    <div className=' flex-col bg-white shadow-2xl rounded-md p-10  w-[400px]   '>
      ...
      <button className='mb-4 bg-blue-500 w-full p-2 rounded-2xl text-white text-xl font-semibold cursor-pointer hover:bg-blue-800'>Signin</button>
      <p className='text-center font-semibold'>New user? <span className='text-blue-600 cursor-pointer font-semibold '>sign</span></p>
    </div>
    </duv>
  )
}
